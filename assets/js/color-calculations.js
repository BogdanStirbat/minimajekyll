 ...
 * @return {Object} - this
 */
function _minimaJekyllColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_minimaJekyllColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_minimaJekyllColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_minimaJekyllColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _minimaJekyllColor object.
 *
 * @since Minima Jekyll 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function minimaJekyllColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _minimaJekyllColor( backgroundColor, accentHue );
