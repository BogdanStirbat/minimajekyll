<?php
/**
 * A template partial to output pagination for the Minima Jekyll default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Newer <span class="nav-short">Posts</span>', 'minimajekyll' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'minimajekyll' ),
