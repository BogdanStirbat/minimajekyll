...
Minima Jekyll WordPress Theme, Copyright 2019-2020 WordPress.org
Minima Jekyll is distributed under the terms of the GNU GPL.
...
Minima Jekyll is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Minima Jekyll bundles the following third-party resources:
...
Bespoke Icons Created For Minima Jekyll
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- MinimaJekyll_SVG_Icons
- minimajekyll_the_theme_svg()
- minimajekyll_get_theme_svg()
- minimajekyll_nav_menu_social_icons()
